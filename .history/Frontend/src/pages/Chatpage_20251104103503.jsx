...
function ChatPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white p-4">
      <div className="relative  rounded-3xl overflow-hidden shadow-xl border border-slate-700/40 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl hover:border-slate-500/40">
