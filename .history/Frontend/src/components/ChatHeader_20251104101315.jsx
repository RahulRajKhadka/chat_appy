    ...
    <>
      <div className="bg-slate-800/50 border-b border-slate-700/50 p-6">
        <div className="flex flex-col items-center gap-4">
          {/* Profile Picture + Online Status + Camera Button */}
          <div className="relative w-24 h-24">
            ...
            {/* Online Status Dot */}
            <span className="absolute bottom-1 right-1 block w-4 h-4 bg-green-500 rounded-full border-2 border-slate-800 animate-pulse"></span>

            {/* Camera Icon Button */}
            <button
              onClick={() => setShowModal(true)}
              className="absolute bottom-1 left-1 bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full transition-colors shadow-lg"
