      ...
      <div className="bg-slate-800 border-b border-slate-700 rounded-b-lg shadow-md">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="relative w-10 h-10">
            ...
            {/* Online Indicator */}
            <span className="absolute bottom-1 block w-4 h-4 bg-green-500 border-2 border-slate-800 rounded-full animate-pulse"></span>

            {/* Camera Button */}
            <button
              onClick={() => setShowModal(true)}
              className="absolute bottom-1  bg-blue-500 hover:bg-blue-600 text-white p-2 rounded-full shadow-md transition"
            >
