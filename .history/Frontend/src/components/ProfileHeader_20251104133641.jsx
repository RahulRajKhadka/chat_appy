...
function ProfileHeader() {
  ...
  return (
    <>
      <div className="w-full p-3 rounded-lg border-b border-green-400 bg-slate-800/50">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute -bottom-1 -right-1 bg-gradient-to-r from-cyan-500 to-cyan-600 
                           hover:from-cyan-600 hover:to-cyan-700 text-white p-1.5 sm:p-2 
                           rounded-full shadow-lg border-2 border-slate-800 
