function ProfileHeader({ onToggleSidebar }) {
  ...
  const isOnline = mockAuthStore.onlineUsers.includes(mockAuthStore.authUser._id);
      ...
      <div className="bg-slate-800/40 backdrop-blur-md p-3 sm:p-4 lg:p-6">
        <div className="flex flex-col items-center gap-3 sm:gap-4 lg:gap-5">
          <div className="relative w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24">
            ...
            <span className={`absolute bottom-0.5 right-0.5 sm:bottom-1 sm:right-1 block w-3 h-3 sm:w-4 sm:h-4 border-2 border-slate-800 rounded-full ${isOnline ? 'bg-green-500 animate-pulse' : 'bg-gray-500'}`} />
