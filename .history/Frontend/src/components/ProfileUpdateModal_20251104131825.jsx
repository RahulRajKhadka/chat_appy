...
function ProfileUpdateModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md sm:max-w-lg md:max-w-md p-5 sm:p-6 border border-slate-700 overflow-y-auto max-h-[90vh]">
        {/* Close Button */}
        <button
          onClick={handleClose}
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-slate-200 mb-6 text-center">
          Update Profile Picture
        </h2>

        <div className="flex flex-col items-center gap-6">
          <div className="relative">
            <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden border-4 border-cyan-500/30">
              <img
